...
В методе `nested` вложенный параллелизм создаёт слишком много накладных расходов, и процессор расходует время не на полезную работу, а на организацию новых команд потоков.  
